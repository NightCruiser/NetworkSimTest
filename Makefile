simulator.out : main.o sim_controller.o creator.o pool.o wired.o packet.o client.o router.o
	g++ BuildFiles/main.o BuildFiles/sim_controller.o BuildFiles/creator.o BuildFiles/pool.o BuildFiles/tpair.o BuildFiles/packet.o BuildFiles/client.o BuildFiles/router.o -o simulator.out -std=c++11 -pthread -Wall -pedantic -g
